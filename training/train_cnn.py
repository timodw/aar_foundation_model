...
def main(args):
    ...
    for epoch in range(args.epochs):
        train_loss, train_acc, train_bal_acc = train_classifier_epoch(model, train_loader, optimizer, criterion, device)
        val_loss, val_acc, val_bal_acc = validate_classifier_epoch(model, val_loader, criterion, device)
